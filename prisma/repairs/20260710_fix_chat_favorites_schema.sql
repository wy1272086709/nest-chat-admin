...
ALTER TYPE "FavoriteType" ADD VALUE IF NOT EXISTS 'MESSAGE';
ALTER TYPE "FavoriteType" ADD VALUE IF NOT EXISTS 'IMAGE';
ALTER TYPE "FavoriteType" ADD VALUE IF NOT EXISTS 'VIDEO';
ALTER TYPE "FavoriteType" ADD VALUE IF NOT EXISTS 'FILE';
ALTER TYPE "FavoriteType" ADD VALUE IF NOT EXISTS 'CHAT_RECORD';
...
ALTER TABLE "chat_favorites"
  ...
  DROP CONSTRAINT IF EXISTS "chat_favorites_userId_fkey";

DROP INDEX IF EXISTS "chat_favorites_userId_targetType_targetId_key";
...
DELETE FROM "chat_favorites" favorite
WHERE NOT EXISTS (
  SELECT 1
  FROM "chat_users" users
  WHERE users."id" = favorite."userId"
);
